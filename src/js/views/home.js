...
import CV from "../../img/rigo-baby.jpg";
      ...
      <ol>
        {Array.isArray(store.contacts) &&
          store.contacts.map((contact) => (
            <li
              className="list-group-item border border-secondary-subtle d-flex align-items-center"
              key={contact.id}
            >
              <img src={CV} className="rounded-circle w-25 h-25 p-5" />
              <div className="ms-3 me-auto">
                <div className="mb-4 fw-bold">{contact.name}</div>
                <div className="mb-4">
                  {" "}
                  <svg
